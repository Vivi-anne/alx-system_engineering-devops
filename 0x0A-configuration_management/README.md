...
In this project, I was Learning Puppet as a configuration management tool, writing Puppet manifest files to create a file, install a package, and execute a command.
